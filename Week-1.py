class Students:
    '''def __init__(self,StudentId,StFiname,StLaname,Course,Year,GPA,University,Email,Mobile):
    ...
    def getMobile(self):
        return self.Mobile
d=Students()
d.setStudentId(2000080184)
d.setStFiname("Lingala")
d.setStLaname("Dhivya Sri")
d.setCourse("AI&DS")
d.setYear(3)
d.setGPA(9.2)
d.setUniversity("KLU")
d.setEmail("dhivyasrilingala24@gmail.com")
d.setMobile(7075482408)
